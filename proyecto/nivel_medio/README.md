...
| Sensores CNY (tráfico) | Solo se muestran en el LCD | Si una vía tiene autos y la otra ninguno, la que tiene autos conserva el verde (modo demanda); con tráfico en ambas, ≥2 detectados en una vía extienden su verde +3 s |
...
- **Demanda**: si una vía tiene al menos un auto (un CNY tapado) y la otra ninguno, la vía con autos **conserva el verde** mientras siga así (no hay a quién darle paso) y la vacía queda en rojo; el LCD dice `DEMANDA` y la telemetría `demanda=1`. Si la vía vacía es la que está en verde y llega un auto a la otra, cede el verde apenas cumple los 2 s mínimos. Con las dos vías vacías o las dos con autos, el ciclo es el normal. El peatón manda sobre el verde sostenido igual que sobre cualquier otro: lo corta si su vía está libre, o a los 6 s como máximo si tiene tráfico.
- **Congestión**: con tráfico en las dos vías, mantener presionado (clic sostenido en Wokwi) 2 o 3 sensores CNY de una vía antes de que empiece su verde → esa fase dura 3 s más. (Si la otra vía está vacía actúa el modo demanda y el verde no termina.)
