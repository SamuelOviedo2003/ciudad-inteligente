// TimerMEF.h - libreria de temporizacion no bloqueante del curso ISA262.
// Copiada literalmente de docs/software/timer-mef.md (el enlace original del sitio esta roto).
#ifndef TimerMEF_h
#define TimerMEF_h
