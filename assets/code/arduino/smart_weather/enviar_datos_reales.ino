// Tomar datos y enviarlos por WiFi
...
void readDHT()
{ // Function that reads DHT sensor and also battery level
  if ((millis() - tiniDHT) > tDHTmeas)
  {
    B = analogRead(SBAT) * 9.2 / 1023.0; // Acquire current battery level voltage
